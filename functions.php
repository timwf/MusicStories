...
function twentytwenty_register_scripts()
{
	...
	wp_enqueue_script('twentytwenty-min-js', get_template_directory_uri() . '/assets/js/jquery.min.js', array(), $theme_version, true);
	wp_enqueue_script('twentytwenty-aos-js', get_template_directory_uri() . '/assets/js/aos.js', array(), $theme_version, true);
	wp_enqueue_script('twentytwenty-lity-js', get_template_directory_uri() . '/assets/js/lity.min.js', array(), $theme_version, true);
	wp_enqueue_script('twentytwenty-main-js', get_template_directory_uri() . '/assets/js/main.js', array(), $theme_version, true);
	wp_enqueue_script('twentytwenty-custom-js', get_template_directory_uri() . '/assets/js/custom.js', array(), $theme_version, true);
	wp_enqueue_script('twentytwenty-slickmin-js', get_template_directory_uri() . '/assets/js/slick.min.js', array(), $theme_version, true);
}
...
function twentytwenty_menus()
{
	...
	$locations = array(
		'primaryleft'  => __('Desktop Horizontal Left Menu', 'twentytwenty'),
		'primaryright'  => __('Desktop Horizontal Right Menu', 'twentytwenty'),
		//'expanded' => __( 'Desktop Expanded Menu', 'twentytwenty' ),
		'footerone'   => __('Footer Column One', 'twentytwenty'),
		'footertwo'   => __('Footer Column Two', 'twentytwenty'),
		'footerthree'   => __('Footer Column Three', 'twentytwenty'),
		'footerfour'   => __('Footer Column Four', 'twentytwenty'),
	);
...
function filter_data()
{
	...
	if (!empty($category_id)) {
		...
		$args['tax_query'] = $t_query;
		$args_total['tax_query'] = $t_query;
	}


	if ($paged != '' && !empty($paged) && $paged != null) {
		$args['paged'] = $paged;
	}
	// print_r($args);
	wp_reset_query();
